...
public class UserRole extends TableImpl<UserRoleRecord> {
     ...
     */
    public final TableField<UserRoleRecord, UUID> USER_ID = createField(DSL.name("user_id"), SQLDataType.UUID, this, "");

    /**
     * The column <code>public.user_role.user_role</code>.
     */
    public final TableField<UserRoleRecord, String> USER_ROLE_ = createField(DSL.name("user_role"), SQLDataType.VARCHAR(20), this, "");
    ...
    public List<ForeignKey<UserRoleRecord, ?>> getReferences() {
        return Arrays.asList(Keys.USER_ROLE__USER_ROLE_USER_ID_FK, Keys.USER_ROLE__USER_ROLE_ROLE_NAME_FK);
    }
    ...
    public User user() {
        if (_user == null)
            _user = new User(this, Keys.USER_ROLE__USER_ROLE_USER_ID_FK);
    ...
    public Role role() {
        if (_role == null)
            _role = new Role(this, Keys.USER_ROLE__USER_ROLE_ROLE_NAME_FK);
